...
public class CheckPoint : MonoBehaviour
{
    ...
    public Vector3[] test = new Vector3[8];
  //  public string objTag;
    ...
    public void OnTriggerEnter(Collider col)
    {
        if (col.gameObject.tag == "Player")
        {
            ...
            gm.lastCheckPointRot[0] = this.transform.rotation;
        }
        ...
        if (col.gameObject.tag == "Player2")
        {
            ...
            gm.lastCheckPointRot[1] = this.transform.rotation;
        }
        ...
        if (col.gameObject.tag == "Player3")
        {
            ...
            gm.lastCheckPointRot[2] = this.transform.rotation;
        }
        ...
        if (col.gameObject.tag == "Player4")
        {
            ...
            gm.lastCheckPointRot[3] = this.transform.rotation;
        }
        ...
        if (col.gameObject.tag == "Player5")
        {
            ...
            gm.lastCheckPointRot[4] = this.transform.rotation;
        }
        ...
        if (col.gameObject.tag == "Player6")
        {
            ...
            gm.lastCheckPointRot[5] = this.transform.rotation;
        }
        ...
        if (col.gameObject.tag == "Player7")
        {
            ...
            gm.lastCheckPointRot[6] = this.transform.rotation;
        }
        ...
        if (col.gameObject.tag == "Player8")
        {
            ...
            gm.lastCheckPointRot[7] = this.transform.rotation;
        }
    }
}
